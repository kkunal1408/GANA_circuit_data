...
subckt INVX2P4 IN OUT VDD VSS
    M3 (OUT IN VDD VDD) pmos_rf lr=60n wr=600n nr=4
    M2 (OUT IN VSS VSS) nmos_rf lr=60n wr=600n nr=2
ends INVX2P4
...
subckt INVX4P8 IN OUT VDD VSS
    M3 (OUT IN VDD VDD) pmos_rf lr=60n wr=1.2u nr=4
    M2 (OUT IN VSS VSS) nmos_rf lr=60n wr=1.2u nr=2
ends INVX4P8
// End of subcircuit definition.
...
subckt TGATE_1U IN OUT VPSLIM_H VPSLIM_L VSS
    M19 (IN VPSLIM_H OUT OUT) nmos_rf lr=60n wr=1u nr=1
    M18 (OUT VPSLIM_L IN IN) pmos_rf lr=60n wr=1u nr=1
ends TGATE_1U
// End of subcircuit definition.
...
subckt INVX9P6 IN OUT VDD VSS
    M3 (OUT IN VDD VDD) pmos_rf lr=60n wr=2.4u nr=4
    M2 (OUT IN VSS VSS) nmos_rf lr=60n wr=2.4u nr=2
ends INVX9P6
// End of subcircuit definition.
...
subckt INVX1P2 IN OUT VDD VSS
    M1 (OUT IN VDD VDD) pmos_rf lr=60n wr=600n nr=2
    M0 (OUT IN VSS VSS) nmos_rf lr=60n wr=600n nr=1
ends INVX1P2
// End of subcircuit definition.
...
subckt NAND_1P2 A B OUT VDD VSS
    M11 (OUT B VDD VDD) pmos_rf lr=60n wr=600n nr=2
    M9 (OUT A VDD VDD) pmos_rf lr=60n wr=600n nr=2
    M8 (OUT B net14 VSS) nmos_rf lr=60n wr=600n nr=4
    M10 (net14 A VSS VSS) nmos_rf lr=60n wr=600n nr=4
ends NAND_1P2
// End of subcircuit definition.
...
subckt TGATE IN OUT VPSLIM_H VPSLIM_L
    M19 (IN VPSLIM_H OUT OUT) nmos_rf lr=60n wr=600n nr=1
    M18 (OUT VPSLIM_L IN IN) pmos_rf lr=60n wr=600n nr=1
ends TGATE
// End of subcircuit definition.
...
subckt ppf_buffer_alt LOIN LOOUT VDD VSS
    M63 (net2 net2 VSS VSS) nmos_rf lr=60n wr=1u nr=4
    M75 (LOOUT net016 VSS VSS) nmos_rf lr=60n wr=1u nr=4
    M62 (net2 net2 VDD VDD) pmos_rf lr=60n wr=1u nr=8
    M74 (LOOUT net016 VDD VDD) pmos_rf lr=60n wr=1u nr=8
...
R3 (P M ) rppolywo l=6u w=1u m=1 mf=(1) mismatchflag=0
...
R5 (VDD  MIXER_LOBIAS) rppolywo l=4u w=1u m=1 mf=(1) mismatchflag=0
R8 (MIXER_LOBIAS VSS ) rppolywo l=4u w=1u m=1 mf=(1) mismatchflag=0
...
subckt TGATE_LARGER_DIFF INM INP OUTM OUTP SEL VDD VSS
    ...
    M4 (INP SEL OUTP VSS) nmos_rf lr=60n wr=1u nr=12
    M0 (INM SEL OUTM VSS) nmos_rf lr=60n wr=1u nr=12
    M1 (OUTP net017 INP VDD) pmos_rf lr=60n wr=1u nr=24
    M2 (OUTM net12 INM VDD) pmos_rf lr=60n wr=1u nr=24
...
subckt CCunit_w_Switch_Sa DCB VDD VSS inm inp outm outp switch tailbias
    M16 (tailbias tailbias VSS VSS) nmos_rf lr=240.0n wr=600n nr=4
    M4 (vtail switch_b VSS VSS) nmos_rf lr=60n wr=1.2u nr=1
    M0 (LOp switch_b VSS VSS) nmos_rf lr=60n wr=2u nr=12
    M9 (LOm switch_b VSS VSS) nmos_rf lr=60n wr=2u nr=12
    M8 (outp LOm net26 net26) nmos_rf lr=100n wr=900n nr=10
    M7 (net26 vtail VSS VSS) nmos_rf lr=240.0n wr=600n nr=20
    M6 (net26 vtail VSS VSS) nmos_rf lr=240.0n wr=600n nr=20
    M5 (outm LOp net26 net26) nmos_rf lr=100n wr=900n nr=10
    ...
    M3 (vtail switch_b net04 net04) pmos_rf lr=60n wr=1.2u nr=1
    M11 (LOm switch_b net21 net21) pmos_rf lr=60n wr=2u nr=1
    M2 (LOp switch_b net14 net14) pmos_rf lr=60n wr=2u nr=1
    M1 (net37 switch_b inp inp) pmos_rf lr=60n wr=2u nr=3
    M10 (net36 switch_b inm inm) pmos_rf lr=60n wr=2u nr=3
...
subckt D2S LOM_IN LOP_IN LO_OUT VDD VSS
    ...
    M19 (net06 net06 VDD VDD) pmos_rf lr=100n wr=1u nr=8
    M21 (LO_OUT net06 VDD VDD) pmos_rf lr=100n wr=1u nr=8
    M20 (LO_OUT net011 VSS VSS) nmos_rf lr=100n wr=1u nr=6
    M12 (net06 net04 VSS VSS) nmos_rf lr=100n wr=1u nr=6
...
subckt ppf_buffer_lp_1stg LOIN LOOUT VDD VSS
    M25 (LOOUT net12 VSS VSS) nmos_rf lr=60n wr=1u nr=2
    M26 (LOOUT net12 VDD VDD) pmos_rf lr=60n wr=1u nr=4
...
R10  (net20  net36) rppolys l=10.5u w=1u m=4 mf=(1) mismatchflag=0
R10  (net15  net30) rppolys l=10.5u w=1u m=4 mf=(1) mismatchflag=0
R9  (net24 net31) rppolys l=10.5u w=1u m=4 mf=(1) mismatchflag=0
R8 (net27 net37) rppolys l=10.5u w=1u m=4 mf=(1) mismatchflag=0
R7  (net35 net24 ) rppolys l=10.5u w=1u m=4 mf=(1) mismatchflag=0
R13 (OUT0 net37 ) rppolys l=10.5u w=1u m=8 mf=(1) mismatchflag=0
R12  (net31 OUT90 ) rppolys l=10.5u w=1u m=8 mf=(1) mismatchflag=0
...
R4  (net33 net15) rppolys l=10.5u w=1u m=1 mf=(1) mismatchflag=0
R2 (INM net35 ) rppolys l=10.5u w=1u m=1 mf=(1) mismatchflag=0
R6  (net34 net27 ) rppolys l=10.5u w=1u m=2 mf=(1) mismatchflag=0
R5 (net32 net20 ) rppolys l=10.5u w=1u m=2 mf=(1) mismatchflag=0
R14  (net36 OUT270 ) rppolys l=10.5u w=1u m=8 mf=(1) mismatchflag=0
R15 (OUT180 net30 ) rppolys l=10.5u w=1u m=8 mf=(1) mismatchflag=0
ends PPF4STAGE_BAK
// End of subcircuit definition.
...
subckt Mux IN1 IN2 OUT SEL VDD VSS
    I2 (SEL net017 VDD VSS) Inv1
    I0 (SEL net12 VDD VSS) Inv1
    M4 (IN1 SEL OUT VSS) nmos_rf lr=60n wr=1u nr=12
    M0 (IN2 net12 OUT VSS) nmos_rf lr=60n wr=1u nr=12
    M1 (OUT net017 IN1 VDD) pmos_rf lr=60n wr=1u nr=24
    M2 (OUT SEL IN2 VDD) pmos_rf lr=60n wr=1u nr=24
ends Mux
// End of subcircuit definition.
...
subckt PS_IBIAS_ALT PS_IBIASIN PS_IBT_I\<0\> PS_IBT_I\<1\> PS_IBT_I\<2\> PS_IBT_I\<3\> PS_IBT_I\<4\> PS_IBT_I\<5\> PS_IBT_I\<6\> PS_IBT_I\<7\> PS_IBT_Q\<0\> PS_IBT_Q\<1\> PS_IBT_Q\<2\> PS_IBT_Q\<3\> PS_IBT_Q\<4\> PS_IBT_Q\<5\> PS_IBT_Q\<6\> PS_IBT_Q\<7\> vdd vss
    M7 (net058 PS_IBIASIN vss vss) nmos_rf lr=240.0n wr=2u nr=4
    M1 (net95 PS_IBIASIN vss vss) nmos_rf lr=240.0n wr=2u nr=4
    M0 (PS_IBIASIN PS_IBIASIN vss vss) nmos_rf lr=240.0n wr=2u nr=4
    M20 (PS_IBT_Q\<7\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M19 (PS_IBT_Q\<6\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M14 (PS_IBT_Q\<5\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M13 (PS_IBT_Q\<4\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M12 (PS_IBT_Q\<3\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M11 (PS_IBT_Q\<2\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M10 (PS_IBT_Q\<1\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M9 (PS_IBT_Q\<0\> net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M8 (net058 net058 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M18 (PS_IBT_I\<7\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M17 (PS_IBT_I\<6\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M16 (PS_IBT_I\<5\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M15 (PS_IBT_I\<4\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M6 (PS_IBT_I\<3\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M5 (PS_IBT_I\<2\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M4 (PS_IBT_I\<1\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M3 (PS_IBT_I\<0\> net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    M2 (net95 net95 vdd vdd) pmos_rf lr=240.0n wr=2u nr=8
    C1 (PS_IBIASIN vss vss) mimcap_woum_sin_rf lt=30u wt=30u lay=7 m=1
    C0 (PS_IBIASIN vss vss) mimcap_woum_sin_rf lt=30u wt=30u lay=7 m=1
ends PS_IBIAS_ALT
// End of subcircuit definition.

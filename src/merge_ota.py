...
OTA_DIR = "OTA"
BIAS_DIR = "BIASING_CIRCUITS"
LG_DIR = "BIASING_CIRCUITS"
...
class create_OTA_connection:
    ...
    def LG_pins(self,lg_pins,lg_type):
        ...
        for idx, port in enumerate(words):
            ...
            if 'bias' in port and port.endswith('O'):
                ...
                #print("input port",self.LG_input)
            else:
    ...
    def BIAS_pins(self,bias_line):
        print("checking input",self.LG_input.lower(),bias_line)
    ...
    if "_" in ON:
        ...
        for LN in LG_NETLIST:
            for BN in BIAS_NETLIST:
                ...
                if check_lg:
                    check_bias = read_bias(LG_DIR+"/"+BN, connect)
                    if check_bias:
                        fo= open("results/"+ON+"_"+LN+"_"+BN,"w")
